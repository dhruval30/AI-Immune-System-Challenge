...
BEST_STATE_DICT_PATH = OUTPUT_DIR / "modernbert_base_best_state_dict.pt"
...
NOTES_PATH = OUTPUT_DIR / "modernbert_base_notes.md"
...
def main() -> None:
    ...
    notes_text = f"""# ModernBERT-base Fine-Tuning Notes
...
- `outputs/modernbert_base/modernbert_base_metrics.json`
- `outputs/modernbert_base/modernbert_base_val_predictions.csv`
- `outputs/modernbert_base/modernbert_base_error_analysis.csv`
- `outputs/modernbert_base/modernbert_base_test_probabilities.csv`
- `outputs/modernbert_base/modernbert_base_submission.csv`
- `outputs/modernbert_base/modernbert_base_notes.md`
- `outputs/modernbert_base/best_model/`
- `outputs/modernbert_base/modernbert_base_best_state_dict.pt`
"""

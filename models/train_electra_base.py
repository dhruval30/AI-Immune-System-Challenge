...
#
# ELECTRA-base baseline for AIS text classification.
# Uses max_length=256 because train/test length inspection showed only about
# 4.7% of rows exceed 256 characters and roughly 1% exceed 384 characters.
...
OUTPUT_DIR = ROOT_DIR / "outputs" / "electra_base"
BEST_MODEL_DIR = OUTPUT_DIR / "best_model"
BEST_STATE_DICT_PATH = OUTPUT_DIR / "electra_base_best_state_dict.pt"
...
METRICS_PATH = OUTPUT_DIR / "electra_base_metrics.json"
VAL_PRED_PATH = OUTPUT_DIR / "electra_base_val_predictions.csv"
ERROR_ANALYSIS_PATH = OUTPUT_DIR / "electra_base_error_analysis.csv"
TEST_PROB_PATH = OUTPUT_DIR / "electra_base_test_probabilities.csv"
SUBMISSION_PATH = OUTPUT_DIR / "electra_base_submission.csv"
NOTES_PATH = OUTPUT_DIR / "electra_base_notes.md"
...
def main() -> None:
    ...
    notes_text = f"""# ELECTRA-base Fine-Tuning Notes

...
OUTPUT_DIR = ROOT_DIR / "outputs" / "baseline_minilm_logreg_cv"
...
TRAIN_EMB_CACHE_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_train_embeddings.npy"
TEST_EMB_CACHE_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_test_embeddings.npy"
TRAIN_EMB_META_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_train_embeddings_meta.json"
TEST_EMB_META_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_test_embeddings_meta.json"

METRICS_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_metrics.json"
OOF_PRED_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_oof_predictions.csv"
ERROR_ANALYSIS_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_error_analysis.csv"
SUBMISSION_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_submission.csv"
NOTES_PATH = OUTPUT_DIR / "baseline_minilm_logreg_cv_notes.md"
...
def main() -> None:
    ...
    metrics = {
        "model": "MiniLM sentence embeddings + LogisticRegression",
        "seed": SEED,
    ...
    notes = f"""# Baseline MiniLM Embeddings + Logistic Regression (CV)

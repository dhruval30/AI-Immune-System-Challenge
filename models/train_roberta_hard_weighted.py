#!/usr/bin/env python3
"""
Train RoBERTa with hard-example sample weighting.
...
OUTPUT_DIR = ROOT_DIR / "outputs" / "roberta_hard_weighted"
BEST_MODEL_DIR = OUTPUT_DIR / "best_model"
BEST_STATE_DICT_PATH = OUTPUT_DIR / "roberta_hard_weighted_best_state_dict.pt"
...
METRICS_PATH = OUTPUT_DIR / "roberta_hard_weighted_metrics.json"
VAL_PRED_PATH = OUTPUT_DIR / "roberta_hard_weighted_val_predictions.csv"
ERROR_ANALYSIS_PATH = OUTPUT_DIR / "roberta_hard_weighted_error_analysis.csv"
TEST_PROB_PATH = OUTPUT_DIR / "roberta_hard_weighted_test_probabilities.csv"
SUBMISSION_PATH = OUTPUT_DIR / "roberta_hard_weighted_submission.csv"
NOTES_PATH = OUTPUT_DIR / "roberta_hard_weighted_notes.md"
WEIGHT_SUMMARY_PATH = OUTPUT_DIR / "roberta_hard_weighted_weight_summary.csv"
FEATURE_THRESHOLDS_PATH = OUTPUT_DIR / "roberta_hard_weighted_feature_thresholds.json"
...
def main() -> None:
    ...
    print(INSTALL_CMD)
    print("\n=== RoBERTa Hard-Weighted Training ===")
    ...
    notes_text = f"""# RoBERTa Hard-Weighted Notes
